...
default['certificate_services']['standalone_root_ca']['crl_delta_overlap_period']               = nil  ##
default['certificate_services']['standalone_root_ca']['crl_delta_overlap_units']                = nil  ##
...
default['certificate_services']['enterprise_subordinate_ca']['crl_delta_overlap_period']        = 'hours'   ####
default['certificate_services']['enterprise_subordinate_ca']['crl_delta_overlap_units']         = 2         ####
